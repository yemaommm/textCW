...
function WinOpen(ss) {
  ...
  <body>
  <div style="width:100%;height:100%;padding:0px;margin:0px;"  align="center"  id='syb'></div>
    <script>
    Ext.onReady(function(){  
     					...
     					*/
     					...
     					Ext.Ajax.request({
     						...
     						success:function(response){
     							sybtxt=document.getElementById('sybDIV').innerHTML=response.responseText;
     						}
     					});
     					sybwin.close();
     				}
    	...
    	var sybP=Ext.create('Ext.panel.Panel', {  
            html:'<div id="sybDIV"></div>',
            layout:'fit',
            height:Ext.get('syb').getViewSize().height,
            autoScroll:true,
            renderTo: 'syb',  
            dockedItems: [{
                dock: 'top',
